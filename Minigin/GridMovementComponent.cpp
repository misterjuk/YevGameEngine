...
namespace yev
{
    GridMovementComponent::GridMovementComponent(GameObject* ownerObjectPtr, Map* map)
        : Component(ownerObjectPtr), m_Map(map)
    {
        m_Transform = ownerObjectPtr->GetComponent<TransformComponent>();
